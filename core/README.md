...
[![latest packaged versions](https://repology.org/badge/latest-versions/haskell:keep-a-changelog.svg)](https://repology.org/project/haskell:keep-a-changelog/versions)

Structure your CHANGELOG.md

A library for reading & writing [Keep a Changelog](https://keepachangelog.com/)-formatted files.
...
This package is licensed under [The GNU AGPL 3.0 only](./LICENSE). If you need a license for usage that isn’t covered under the AGPL, please contact [Greg Pfeil](mailto:greg@technomadic.org?subject=licensing%20keep-a-changelog).
